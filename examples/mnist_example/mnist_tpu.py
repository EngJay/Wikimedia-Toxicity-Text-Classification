...
from examples.mnist_example import dataset  # pylint: disable=wrong-import-position
from examples.mnist_example import mnist  # pylint: disable=wrong-import-position
