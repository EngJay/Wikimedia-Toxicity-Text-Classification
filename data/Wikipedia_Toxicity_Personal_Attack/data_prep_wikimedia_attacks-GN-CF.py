...
#     unk = len(vocab) - 1
    ...
    f = BytesIO(file_io.read_file_to_string('../Google-News-Embeddings/GoogleNews_CF_word2id.bin',
                                            binary_mode=True))
    ...
    date_filename = 'wikimedia-personal-attacks-min-' + str(min_num_votes) + '-votes-GN-CF-Encoded-data.bin'
