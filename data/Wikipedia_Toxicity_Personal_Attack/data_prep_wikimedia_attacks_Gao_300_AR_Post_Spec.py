...
def main(argv):
    ...
    try:
        ...
        print('data_prep_wikimedia_attacks_Gao_300_AR_Post_Spec.py -m <min_num_votes> -d <data_path>')
        sys.exit(2)
    for opt, arg in opts:
        if opt == '-h':
            print('data_prep_wikimedia_attacks_Gao_300_AR_Post_Spec.py\n'
                  + 'Defaults:\n'
...
#     unk = len(vocab) - 1
    ...
    date_filename = 'WM-PA-Data-Gao-300-AR-PostSpec-min-' + str(min_num_votes) + '-votes.bin'
