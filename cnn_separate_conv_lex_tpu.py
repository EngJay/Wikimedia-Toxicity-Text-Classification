...
tf.flags.DEFINE_string("save_model", None, "Export trained estimator.")
...
# Feature spec is required for the serving input receiver function.
# feature_spec = {'comment': tf.FixedLenFeature(shape=[], dtype=tf.float32)}
...
def run_model(features, params, training=True):
    ...
    # lex_embedding_size is the 1nd dimension.
